...
abstract class IntegrationTestCassandraStartup(
    ...
    companion object {
        private const val EXPECTED_EXISTING_CONTAINER_NAME = "/transcriber-integration-test-cassandra"
        private const val IP_ADDRESS_ENV_NAME = "TRANSCRIBER_INTEGRATION_CASSANDRA_DB_IP_ADDRESS"
        private const val PORT_ENV_NAME = "TRANSCRIBER_INTEGRATION_CASSANDRA_DB_PORT"
    }
