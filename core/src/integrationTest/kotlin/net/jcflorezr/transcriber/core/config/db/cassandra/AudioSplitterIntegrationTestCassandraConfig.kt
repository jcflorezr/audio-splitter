...
@Configuration
@Lazy
open class AudioSplitterIntegrationTestCassandraConfig : IntegrationTestCassandraConfig() {

    private val thisClass: Class<AudioSplitterIntegrationTestCassandraConfig> = this.javaClass
