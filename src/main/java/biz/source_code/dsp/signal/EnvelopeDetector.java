...
public class EnvelopeDetector {
     ...
     *
     * @param samplingRate Sampling rate in Hz.
     * @param attackTime   Attack time of the envelope detector in seconds (time for 1/e convergence).
     * @param releaseTime  Release time of the envelope detector in seconds (time for 1/e convergence).
     * @param iirFilter    Filter for pre-processing the signal. May be null to bypass filtering.
     */
