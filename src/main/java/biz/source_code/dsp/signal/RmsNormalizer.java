...
public class RmsNormalizer {
     ...
     *
     * @param signals     The multi-channel signal values.
     * @param targetRms   Target RMS amplitude.
     * @param segmentSize Number of signal samples to be used per RMS measurement.
     */
